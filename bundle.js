...
var CaffeinePage = require('./pages/CaffeinePage');
// endinject

var menuItems = [
  // inject:menuitems
  { payload: 'home', text: 'Lab3 Application' },
  { payload: 'about', text: 'About' },
  { payload: 'caffeine', text: 'Caffeine' },
  // endinject
];

var titles = {
  // inject:titles
  '/home': 'Lab3 Application',
  '/about': 'About',
  '/caffeine': 'Caffeine',
  // endinject
};
...
var routes = (
  React.createElement(Route, {name: "app", path: "/", handler: Master}, 
    ...
    React.createElement(Route, {name: "caffeine", handler: CaffeinePage}), 
    /* endinject */
...
},{"./pages/AboutPage":250,"./pages/CaffeinePage":251,"./pages/HomePage":252,"material-ui":7,"react":249,"react-router":50,"react-tap-event-plugin":87}],2:[function(require,module,exports){
/*!
  ...
  render: function () {
    return (
      React.createElement("div", {className: "about-page"}, 
        React.createElement("ul", null, "Jennifer Adriana Lee"), 
        React.createElement("ul", null, "301169039"), 
        React.createElement("ul", null, "LabD103")
      )
    );
  }
...
var arr = ['latte', 'flat white', 'americano', 'frappucino']

module.exports = React.createClass({displayName: "exports",
  render: function () {
    return (
      React.createElement("div", {className: "caffeine-page"}, 
        React.createElement("div", {className: "coffee"}, "Coffee"), 
        		arr.map(function (element) {
        			return React.createElement("span", null, React.createElement("li", {className: "list"}, element))
        			})
...
},{"react":249}],252:[function(require,module,exports){
var React = require('react');
